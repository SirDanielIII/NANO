...
#### `Modpack Revision: 3.2.0`

#### `Fabric Loader: 0.16.14`

### 🔄 Revision 3.2.0 Changelog

<details>

**Note:** Many OptiFine feature mods haven't been updated yet since OptiFine itself is currently only available up to 1.21.4 😒

#### 📝 General Updates

- Updated all mods to their latest versions.
- Added **NANO support for Minecraft 1.21.5**.
    - Using [Screencopy](https://modrinth.com/mod/screencopy) for 1.21.5 since [Screenshot to Clipboard](https://modrinth.com/mod/screenshot-to-clipboard) needs to be updated.
- Fixed some issues with the [Mod List](#mod-list). 👇

#### ✅ Additions

- Added [Entity Sound Features](https://modrinth.com/mod/esf) to allow variation of an entity's sounds based on the ETF / OptiFine .properties format.
- Added [Puzzle](https://modrinth.com/mod/puzzle) to add resourcepack features and a GUI to configure OptiFine alternatives more conveniently.

#### ❌ Removals

- Removed [pv-addon-sculk](https://modrinth.com/plugin/pv-addon-sculk) — it's a server-side mod, not needed client-side.
- Removed [Screenshot Organisation](https://modrinth.com/mod/screenshot-organisation) — the mod doesn't really work.

#### 🧪 Experimental Mods

- Introduced an **"Experimental"** folder in each NANO modpack.
    - Contains **experimental or alternative mods**.
    - See [Experimental Mods](#experimental-mods) for more details.
...
* The mods in this modpack are categorized
  into [Performance](#performance), [OptiFine Features](#optifine-features), [Utility](#utility), [Extra Features](#extra-features), [Libraries](#libraries),
  and [Experimental Mods](#experimental-mods).
...
| [(ESF) Entity Sound Features](https://modrinth.com/mod/esf)                     | [Traben](https://modrinth.com/user/Traben)                         | ❌      | ❌      | ❌      | ✅      | ✅      | ✅      | ❌      | ✅      | Allows the variation of an entity's sounds based on the ETF / OptiFine .properties format. <br/><br/>⚠️ Crashes on 1.21.4.                                                                                                                |
...
| [Puzzle](https://modrinth.com/mod/puzzle)                                       | [Motschen](https://modrinth.com/user/Motschen)                     | ❌      | ❌      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | Adds resourcepack features and a GUI to configure OptiFine alternatives more conveniently.                                                                                                                                                |
...
| [Screencopy](https://modrinth.com/mod/screencopy)                           | [imurx](https://modrinth.com/user/imurx)                       | ✅      | ❌      | ❌      | ❌      | ❌      | ❌      | ❌      | ❌      | Copies screenshots to the clipboard.                                                       |
...
* If you use Flashback, you need to delete Replay Mod and pv-addon-replaymod.
    * Keep in mind that Flashback has built in proximity chat recordings with Simple
      Voice Chat.
* If you use Simple Voice Chat, you need to delete PlasmoVoice.
...
| [Flashback](https://modrinth.com/mod/flashback)                    | [Moulberry](https://modrinth.com/user/Moulberry) | ❌      | ❌      | ❌      | ❌      | ❌      | ✅      | ✅      | ✅      | A more modern and practical replacement for Replay Mod.                                                                                                                |
