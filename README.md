...
| [ViaFabricPlus](https://modrinth.com/mod/viafabricplus)                     | [FlorianMichael](https://modrinth.com/user/FlorianMichael)     | ❌      | ❌      | ❌      | ✅      | ✅      | ✅      | ✅      | ✅      | Allows seamless switching between Minecraft versions in Multiplayer. <br/><br/>⚠️ Warning 1: Can be buggy sometimes. |
...
| Name                                                                          | Author                                               | 1.16.5 | 1.17.1 | 1.18.2 | 1.19.4 | 1.20.1 | 1.20.4 | 1.20.2 | 1.20.6 | Description                                                                                                                                                                                                                                                 |
|-------------------------------------------------------------------------------|------------------------------------------------------|--------|--------|--------|--------|--------|--------|--------|--------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| [pv-addon-replaymod](https://modrinth.com/mod/pv-addon-replaymod)             | [kpids](https://modrinth.com/user/kpids)             | ❌      | ❌      | ❌      | ✅      | ✅      | ✅      | ✅      | 🟡     | Records voice chat in ReplayMod recordings. <br/><br/>✏️ Requires Plasmo Voice & Replay Mod.                                                                                                                                                                |                                                                                 |
| [pv-addon-sound-physics](https://modrinth.com/mod/pv-addon-soundphysics/)     | [kpids](https://modrinth.com/user/kpids)             | ❌      | ❌      | ❌      | ✅      | ✅      | ✅      | ✅      | ✅      | Integrates sound physics with Plasmo Voice. <br/><br/>✏️ Requires Plasmo Voice & Sound Physics Remastered.                                                                                                                                                  |
| [pv-addon-sculk](https://modrinth.com/plugin/pv-addon-sculk)                  | [kpids](https://modrinth.com/user/kpids)             | ❌      | ❌      | ❌      | ✅      | ✅      | ✅      | ✅      | ✅      | Warden and sculk sensors are triggered with proximity voice chat. <br/><br/>✏️ Requires Plasmo Voice.                                                                                                                                                       |
