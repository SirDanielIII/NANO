...
- Added [Entity Sound Features](https://modrinth.com/mod/esf) for allowing the variation of an entity's sounds based on the ETF / OptiFine .properties format.
...
| Name                                                                                | Author                                                       | 1.16.5 | 1.17.1 | 1.18.2 | 1.19.4 | 1.20.6 | 1.21.4 | 1.21.5 | Description                                                                                                                                                                                                                   |
|-------------------------------------------------------------------------------------|--------------------------------------------------------------|--------|--------|--------|--------|--------|--------|--------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
