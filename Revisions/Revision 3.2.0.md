...
- Re-added NANO support for Minecraft 1.21.1.
- Fixed issues with the [Mod List](#mod-list). 👇
...
- Removed [pv-addon-sculk](https://modrinth.com/plugin/pv-addon-sculk) — it's a server-side mod. 😅
