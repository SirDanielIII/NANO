...
* Added [UniLib](https://modrinth.com/mod/unilib) since newer versions of [CraftPresence](https://modrinth.com/mod/craftpresence) now require it. **It's only needed if you're using
  CraftPresence**.
...
* Removed [pv-addon-sound-physics](https://modrinth.com/mod/pv-addon-soundphysics/) because it ruins proximity chat underwater
